...
def first_query():
    """
    making spark dataframe with results for first query
...
def second_query():
    """
    making spark dataframe with results for second query
...
def third_query():
    """
    making spark dataframe with results for third query
...
def fourth_query():
    """
    making spark dataframe with results for fourth query
...
def fifth_query():
    """
    making spark dataframe with results for fifth query
...
def sixth_query():
    """
    making spark dataframe with results for sixth query
...
def seventh_query():
    """
    making spark dataframe with results for seventh query
    ...
    return seventh_result


saving_into_json(first_query(), "first_result")
saving_into_json(second_query(), "second_result")
saving_into_json(third_query(), "third_result")
saving_into_json(fourth_query(), "fourth_result")
saving_into_json(fifth_query(), "fifth_result")
saving_into_json(sixth_query(), "sixth_result")
saving_into_json(seventh_query(), "seventh_result")